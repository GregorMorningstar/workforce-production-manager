        ...
        return (
            <>
                ...
                <div className="relative min-h-screen overflow-hidden bg-black">
                    ...
                    <div className="relative mx-auto flex min-h-screen w-full max-w-[1600px] items-center px-6 py-10 lg:px-10">
                        <div className="grid w-full items-center gap-10 lg:grid-cols-2 lg:gap-8 xl:gap-12">
                            <section className="max-w-3xl text-white lg:pr-8 xl:pr-14">
                                <img
                                    src="https://pans.krosno.pl/wp-content/uploads/2023/04/logo-pans.webp"
                                    alt="Państwowa Akademia Nauk Stosowanych w Krośnie"
                                    className="mb-8 h-auto w-full max-w-[760px] rounded-2xl bg-white/95 p-3 shadow-[0_20px_70px_rgba(255,255,255,0.08)]"
                                />

                                        <p className="text-sm font-semibold uppercase tracking-[0.28em] text-[#ffd166]">
                                            Instytut Politechniczny
                                        </p>
                                        <div className="space-y-2 text-sm leading-7 text-white/78 sm:text-base">
                                            <p>Kierunek: Inżynieria Produkcji</p>
                                            <p>Kształcenie w zakresie: Systemy informatyczne w inżynierii produkcji</p>
                                        </div>

                                <div className="mt-8 space-y-1 border-l border-white/15 pl-5 text-white/88">
                                    <p className="text-2xl font-semibold tracking-[0.02em]">Grzegorz Stasiowski</p>
                                    <p className="text-sm uppercase tracking-[0.18em] text-white/55">Nr albumu: 12191</p>
                                </div>

                                <div className="mt-10 max-w-3xl rounded-[28px] border border-[#2ee0b6]/20 bg-[#2ee0b6]/10 p-6 shadow-lg backdrop-blur-md sm:p-8">
                                    <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#2ee0b6]">
                                        Praca dyplomowa magisterska
                                    </p>
                                    <h1 className="mt-4 text-2xl font-semibold leading-tight text-white sm:text-3xl lg:text-4xl">
                                        Projekt i implementacja zintegrowanego systemu informatycznego wspomagającego zarządzanie zasobami ludzkimi oraz utrzymaniem ruchu w przedsiębiorstwie produkcyjnym
                                    </h1>
                                    <div className="mt-8 text-sm leading-7 text-white/72 sm:text-base">
                                        <p>Praca dyplomowa magisterska napisana pod kierunkiem:</p>
                                        <p className="mt-2 text-lg font-medium text-white">dr inż. Hubert Wojtowicz</p>
                                    </div>
                                </div>
                            </section>
